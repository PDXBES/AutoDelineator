  ...
  public class Delineator
  {
    ...
    private IEnvelope _GetSurfaceOutputExtent()
    {
      ...
      if (_setupOp.Catchments != null)
      {
        ...
        // Project all source shapes to catchment coordinate system
        ISpatialReference catchmentSpatialRef = ((IGeoDataset)_setupOp.Catchments).SpatialReference;
        foreach (IGeometry sourceShape in sourceShapes)
        {
          sourceShape.Project(catchmentSpatialRef);
        }
